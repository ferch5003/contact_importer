...
ActiveRecord::Schema.define(version: 2021_11_22_205522) do
  ...
  create_table "contact_files", force: :cascade do |t|
    ...
    t.index ["deleted_at"], name: "index_contact_files_on_deleted_at"
  ...
  create_table "failed_contacts", force: :cascade do |t|
    ...
    t.index ["deleted_at"], name: "index_failed_contacts_on_deleted_at"
